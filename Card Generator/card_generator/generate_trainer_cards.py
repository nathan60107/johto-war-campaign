...
class TrainerCard:
    ...
    def _add_emblem(self, img):
        logo_emblem = get_img(TRAINER_CARD_ASSETS / 'emblems' / 'custom.png', xy(0.5, 0.5))
        img.paste(logo_emblem, xy(27, 15), logo_emblem)
